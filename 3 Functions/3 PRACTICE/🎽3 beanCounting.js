...
1) Write a function countBs that takes a string as its only argument and returns
a number that indicates how many uppercase “B” characters there are in the
string.
2) Next, write a function called countChar that behaves like countBs, except
